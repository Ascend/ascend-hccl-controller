...
import (
	...
	mpiv1 "hccl-controller/pkg/apis/training/mpi/v1"
	versioned "hccl-controller/pkg/client/training/mpi/clientset/versioned"
	internalinterfaces "hccl-controller/pkg/client/training/mpi/informers/externalversions/internalinterfaces"
	v1 "hccl-controller/pkg/client/training/mpi/listers/mpi/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MeituanV1().MPIJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeituanV1().MPIJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&mpiv1.MPIJob{},
		resyncPeriod,
