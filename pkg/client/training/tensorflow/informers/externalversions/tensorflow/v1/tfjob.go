...
import (
	...
	tensorflowv1 "hccl-controller/pkg/apis/training/tensorflow/v1"
	versioned "hccl-controller/pkg/client/training/tensorflow/clientset/versioned"
	internalinterfaces "hccl-controller/pkg/client/training/tensorflow/informers/externalversions/internalinterfaces"
	v1 "hccl-controller/pkg/client/training/tensorflow/listers/tensorflow/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.MeituanV1().TFJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeituanV1().TFJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&tensorflowv1.TFJob{},
		resyncPeriod,
