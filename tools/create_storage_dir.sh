...
cd log
mkdir -p -m 750 apigw apigw-business cluster-manager data-manager dataset-manager edge-manager image-manager label-manager model-manager inference-manager train-manager user-manager alarm-manager
cd ../../../..
