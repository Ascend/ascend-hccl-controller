...
go test -v -race -coverprofile cov.out ${TOP_DIR}/pkg/ring-controller/controller > ./$file_input
...
echo "<html<body><h1>HCCL testCase</h1><table border="1">" >> ./$file_detail_output
echo "<html<body><h1>==================================================</h1><table border="2">" >> ./$file_detail_output
while read line
do
  echo -e "<tr>
